...
<div class="col-sm-10 col-sm-offset-1">
   ...
   <div class="panel panel-default" id="viewPanel">
		<div class="panel-header" id="adminHomeHeader">
			<h3 class="panel-title" style="color:#ccc">Search results for "<em><?= $searchtext; ?></em>"</h3>
		</div>
...
<?php else: ?>
   <div class="alert alert-danger" align="center" style="height:400px">
      <h4>No result's found for "<em><?= $searchtext; ?></em>"</h4>
   </div>
<?php endif; ?>
</div> <!-- end of container -->
