<div class="col-sm-7">
  ...
  <div class="row" id="updateH3">
    ...
    <?php $offset = 0; ?>
    <a href="<?= base_url(); ?>shop/fashion_del/<?php echo $offset; ?>/1/9/Clothing">
   ...
   <a href="<?= base_url(); ?>shop/fashion_del/<?php echo $offset; ?>/1/9/Bags">
    ...
    <div class="row" id="secindUpdateRow">
      <a href="<?= base_url(); ?>shop/fashion_del/<?php echo $offset; ?>/1/9/Sports">
         <div class="pull-left" id="updateFashion" onmouseover="zoomIn($(this))" onmouseout="zoomOut($(this))">
           <span id="spanFashion">sports</span>
           <img src="<?php echo base_url(); ?>images/default_img//skate.jpg" class="img-responsive" width="224px">
         </div>
      </a>
      <a href="<?= base_url(); ?>shop/fashion_del/<?php echo $offset; ?>/1/9/Accesories">
         <div class="pull-left" id="updateFashion" onmouseover="zoomIn($(this))" onmouseout="zoomOut($(this))">
