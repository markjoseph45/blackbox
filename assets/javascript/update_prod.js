...
(function(){
    var productNameUpdate = document.getElementById('prod_name').value;
    if (productNameUpdate.length > 5 && productNameUpdate != '') {
      finalProductName = productNameUpdate;
    }
}());
(function(){
    var productDetailsUpdate = document.getElementById('details').value;
    if (productDetailsUpdate.length > 5 && productDetailsUpdate != '') {
      finalProductDetails = productDetailsUpdate;
    }
}());
(function(){
    var productBrandUpdate = document.getElementById('brand').value;
    if (productBrandUpdate != '') {
      finalProductBrandName = productBrandUpdate;
    }
}());
(function(){
    var productPriceUpdate = document.getElementById('price').value;
    if (productPriceUpdate != '') {
      finalProductPrice = productPriceUpdate;
      document.getElementById('forProdPrice').value = productPriceUpdate;
    }
}());

(function(){
    var productPriceDiscountUpdate = document.getElementById('priceDiscount').value;
    if (productPriceDiscountUpdate != '' && productPriceDiscountUpdate != '0.00') {
      document.getElementById('forPriceDiscount').value = productPriceDiscountUpdate;
    }
}());
(function(){
    var productPriceOffUpdate = document.getElementById('pricePercentOff').value;
    if (productPriceOffUpdate != '' && productPriceOffUpdate != '0.00') {
      document.getElementById('forPriceOff').value = productPriceOffUpdate;
    }
}());

(function(){
    var productStocksUpdate = document.getElementById('stocks').value;
    if (productStocksUpdate != '') {
      finalProductStocks = productStocksUpdate;
    }
}());
(function(){
    var productCategoryUpdate = document.getElementById('category').value;
    if (productCategoryUpdate != '') {
      finalProductCategory = productCategoryUpdate;
    }
}());
(function(){
    var productCategoryUpdate = document.getElementById('category').value;
    switch (productCategoryUpdate){
      case 'Clothing':
...
function reload(){
  ...
  (function (){
      ...
      var image1ForUpdate = document.getElementById('dropzone').src;
      var image1Insert = image1ForUpdate.substring(image1ForUpdate.lastIndexOf("/") + 1);
      var main_Image = document.getElementById('forMainImage');
      main_Image.value = image1Insert;
      prod_images1 = '../../images/products/'+image1Insert;
      var displayUploads = function(data){
                  ...
                  setTimeout(function(){
                    ...
                    image1.src = '';
                    image1.src = '../../images/products/'+data[0].name;
                    prod_images1 = '../../images/products/'+data[0].name;
      ...
      var upload = function(files){
        ...
        if (files.length > 1) {
          ...
          xhr.open('post', '/blackbox/shop/upload');
          xhr.send(formData);
          }
        }
...
/////////////////////////////////////// Image 2 ////////////////////////////////////////
  (function (){
      ...
      var image2ForUpdate = document.getElementById('sec_image').src;
      var image2Insert = image2ForUpdate.substring(image2ForUpdate.lastIndexOf("/") + 1);
      prod_images2 = '';
      if (image2Insert != 'circleDrop.jpg') {
          secImage.value = image2Insert;
          prod_images2 = '../../images/products/'+image2Insert;
      }
      var displayUploads = function(data){
                  var loader = '../../images/default_img/default (7).svg';
                  ...
                  setTimeout(function(){
                    ...
                    image2.src = '';
                    image2.src = '../../images/products/'+data[0].name;
                    prod_images2 = '../../images/products/'+data[0].name;
...
/////////////////////////////////////// Image 3 ////////////////////////////////////////
  (function (){
      ...
      var image3ForUpdate = document.getElementById('third_image').src;
      var image3Insert = image3ForUpdate.substring(image3ForUpdate.lastIndexOf("/") + 1);
      prod_images3 = '';
      if (image3Insert != 'circleDrop.jpg') {
          trirdImage.value = image3Insert;
          prod_images3 = '../../images/products/'+image3Insert;
      }
      var displayUploads = function(data){
                  var loader = '../../images/default_img/default (7).svg';
                  ...
                  setTimeout(function(){
                    ...
                    image3.src = '';
                    image3.src = '../../images/products/'+data[0].name;
                    prod_images3 = '../../images/products/'+data[0].name;
...
/////////////////////////////////////// Image 4 ////////////////////////////////////////
  (function (){
      ...
      var image4ForUpdate = document.getElementById('fourth_image').src;
      var image4Insert = image4ForUpdate.substring(image4ForUpdate.lastIndexOf("/") + 1);
      prod_images4 = '';
      if (image4Insert != 'circleDrop.jpg') {
          fourthImage.value = image4Insert;
          prod_images4 = '../../images/products/'+image4Insert;
      }
      var displayUploads = function(data){
                  var loader = '../../images/default_img/default (7).svg';
                  ...
                  setTimeout(function(){
                    ...
                    image4.src = '';
                    image4.src = '../../images/products/'+data[0].name;
                    prod_images4 = '../../images/products/'+data[0].name;
...
/////////////////////////////////////// Image 5 ////////////////////////////////////////
  (function (){
      ...
      var image5ForUpdate = document.getElementById('fifth_image').src;
      var image5Insert = image5ForUpdate.substring(image5ForUpdate.lastIndexOf("/") + 1);
      prod_images5 = '';
      if (image5Insert != 'circleDrop.jpg') {
          fifthmage.value = image5Insert;
          prod_images5 = '../../images/products/'+image5Insert;
      }
      var displayUploads = function(data){
                  var loader = '../../images/default_img/default (7).svg';
                  ...
                  setTimeout(function(){
                    ...
                    image5.src = '';
                    image5.src = '../../images/products/'+data[0].name;
                    prod_images5 = '../../images/products/'+data[0].name;
  ...
  function checkDiscount(){
    ...
    if (productPrice.length <= 0) {
      ...
      var resultpriceOff = priceOff * 100;
